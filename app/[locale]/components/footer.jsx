        ...
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold uppercase text-white flex items-center gap-2">
              <BsFillCartCheckFill className="text-2xl text-light-blue-800" />
              {t("ourproducts")}
            </h2>
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold uppercase text-white  flex items-center gap-2">
              <HiUserGroup className="text-teal-700 text-2xl" />
              {t("contactus")}
            </h2>
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold uppercase text-white flex items-center gap-2">
              <MdOutlineElectricBolt className="text-blue-700 text-2xl" />{" "}
              {t("quicklinks")}
            </h2>
            <ul className="text-gray-400 font-medium">
              <li className="mb-4">
              ...
              <li className="mb-4">
                <a
                  ...
                  className="hover:underline flex items-center gap-2"
                >
                  <BsFileEarmarkPdfFill className="text-red-700 text-2xl" />{" "}
                  {t("catalog")}
                </a>
              </li>
              <li className="mb-4">
          ...
          <div>
            ...
            <ul className="text-gray-400 font-medium ">
              <li className="mb-4 flex items-center gap-2">
                <GiEgyptianSphinx className="text-yellow-700 text-2xl" />{" "}
                {t("location")}
              </li>
            </ul>
          </div>

  ...
  return (
    ...
    <div className="flex flex-col md:flex-row  items-center justify-around text-center">
    {
      loading&&items.map((item,index)=>{
        return(
          <div className="flex flex-col flex-wrap items-center gap-4" key={index}>
          <Avatar src={`http://localhost:8000${item.image}`} color="pink" key={index} className="w-[200px] p-1 h-[200px]  hover:w-[220px] hover:h-[220px] duration-300"  withBorder={true} alt="avatar" />
          <div key={index}>
